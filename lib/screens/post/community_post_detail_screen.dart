...
class _CommunityPostDetailScreenState extends State<CommunityPostDetailScreen> {
                ...
                ..._existingPictures.map((pic) {
                  ...
                  if (path != null && path.isNotEmpty) {
                    imageWidget = Image.network(
                      "http://192.168.219.106:8080/ourlog/picture/display/$path",
                      fit: BoxFit.cover,
  ...
  Widget _buildDetailView() {
    ...
    if (post.thumbnailImagePath != null && post.thumbnailImagePath!.isNotEmpty) {
      thumbnailUrl = "http://192.168.219.106:8080/ourlog/picture/display/${post.thumbnailImagePath}";
    } else if (allPics.isNotEmpty) {
      final first = allPics.first;
      if (first.resizedImagePath != null && first.resizedImagePath!.isNotEmpty) {
        thumbnailUrl = "http://192.168.219.106:8080/ourlog/picture/display/${first.resizedImagePath}";
      } else if (first.thumbnailImagePath != null && first.thumbnailImagePath!.isNotEmpty) {
        thumbnailUrl = "http://192.168.219.106:8080/ourlog/picture/display/${first.thumbnailImagePath}";
      } else if (first.originImagePath != null && first.originImagePath!.isNotEmpty) {
        thumbnailUrl = "http://192.168.219.106:8080/ourlog/picture/display/${first.originImagePath}";
      } else {
        thumbnailUrl = null;
      }
    } else {
        ...
        child: ListView.separated(
          ...
          itemBuilder: (_, idx) {
            ...
            if (pic.resizedImagePath != null && pic.resizedImagePath!.isNotEmpty) {
              imageUrl = "http://192.168.219.106:8080/ourlog/picture/display/${pic.resizedImagePath}";
            } else if (pic.thumbnailImagePath != null && pic.thumbnailImagePath!.isNotEmpty) {
              imageUrl = "http://192.168.219.106:8080/ourlog/picture/display/${pic.thumbnailImagePath}";
            } else if (pic.originImagePath != null && pic.originImagePath!.isNotEmpty) {
              imageUrl = "http://192.168.219.106:8080/ourlog/picture/display/${pic.originImagePath}";
            }
            if (imageUrl == null) {
              return Container(
                width: 120,
