  ...
  factory Artwork.fromJson(Map<String, dynamic> json, {bool isArtist = false}) {
    String getImageUrl(Map<String, dynamic> item) {
      if (item['pictureDTOList'] != null && item['pictureDTOList'].isNotEmpty) {
        ...
        if (picData['resizedImagePath'] != null) return "http://10.100.204.124:8080/ourlog/picture/display/${picData['resizedImagePath']}";
        if (picData['thumbnailImagePath'] != null) return "http://10.100.204.124:8080/ourlog/picture/display/${picData['thumbnailImagePath']}";
        if (picData['originImagePath'] != null) return "http://10.100.204.124:8080/ourlog/picture/display/${picData['originImagePath']}";
        if (picData['fileName'] != null) return "http://10.100.204.124:8080/ourlog/picture/display/${picData['fileName']}";
      } else {
        if (item['resizedImagePath'] != null) return "http://10.100.204.124:8080/ourlog/picture/display/${item['resizedImagePath']}";
        if (item['thumbnailImagePath'] != null) return "http://10.100.204.124:8080/ourlog/picture/display/${item['thumbnailImagePath']}";
        if (item['originImagePath'] != null) return "http://10.100.204.124:8080/ourlog/picture/display/${item['originImagePath']}";
        if (item['fileName'] != null) return "http://10.100.204.124:8080/ourlog/picture/display/${item['fileName']}";
      }
      return "http://10.100.204.124:8080/ourlog/picture/display/default-image.jpg";
    }
