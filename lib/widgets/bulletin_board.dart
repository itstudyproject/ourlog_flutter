...
class _BulletinBoardState extends State<BulletinBoard> {
  ...
  Future<void> fetchPostsByCategory() async {
    ...
    for (final entry in boardIdMap.entries) {
      ...
      final url =
          'http://10.100.204.157:8080/ourlog/post/list?boardNo=$boardNo&size=10&type=t&keyword=';
        ...
        if (response.statusCode == 200) {
          ...
          final posts =
              dtoList.map((item) {
                ...
                if (pic != null) {
                  thumbnail =
                      'http://10.100.204.157:8080/ourlog/picture/display/${pic['path']}/s_${pic['uuid']}_${pic['picName']}';
                }
